...
def HTseqwrapperfun(sam, gtf, prefix):
    output = subprocess.check_output('htseq-count -m union -r pos -i gene_id -a 10 --stranded=no {} {} > {}counts.txt'.format(sam,gtf,prefix), shell=True)
    return output
